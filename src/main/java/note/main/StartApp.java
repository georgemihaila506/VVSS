...
public class StartApp {
	...
	public static void main(String[] args) throws ClasaException {
		...
		NoteRepositoryMock repositoryNote = new NoteRepositoryMock();
		EleviRepositoryMock repositoryElevi = new EleviRepositoryMock();
		ClasaRepositoryMock repository = new ClasaRepositoryMock();
		NoteController ctrl = new NoteController(repositoryNote, repository, repositoryElevi);
